...
// One cinematic base gradient shared across every product card — the
// dialect-fusion move. Differentiation happens through the product's
// name, tier chip, and geometry density inside ProductScene.
const CARD_BG = 'linear-gradient(135deg, #0A0010 0%, #170220 45%, #2E063D 100%)';
const SCENE_COLORS = ['#9D20D6', '#BB50EE']; // canonical brand pair

const products = [
  {
    id: 'leynna-sapphire',
    name: 'Leynna Sapphire',
    tier: 'Flagship · MicroLED TV',
    tagline: 'Furniture-Grade Cinema Television',
  ...
  },
  {
    id: 'leynna-cosmo',
    name: 'Leynna Cosmo',
    tier: 'Premium · MicroLED Panels',
    tagline: 'Eco & Ultra Engines · P0.93 to P1.56',
  ...
  },
  {
    ...
    tier: 'Bridge · Entry MicroLED',
    tagline: 'TrueHue COB on the Universal Cabinet',
  ...
  },
  {
    id: 'reyansh-indoor',
    name: 'Reyansh Indoor',
    tier: 'Workhorse · Indoor MiniLED',
    tagline: 'The Indian Corporate & Retail Workhorse',
  ...
  },
  {
    ...
    tier: 'DOOH · Outdoor MiniLED',
    tagline: 'Brilliance Under Any Sky',
  ...
  },
  {
    ...
    tier: 'Creative · Curves & Columns',
    tagline: 'TrueHue GOB — Arches, Columns, Curved Walls',
      ...
      <div id="products" className="products__inner">
        ...
        >
          <div className="products__card">
            ...
            <div className="products__card-glow" aria-hidden="true" />
            <div className="products__card-content">
              <div className="products__card-left">
                {products[activeProduct].tier && (
                  <span className="products__card-tier">{products[activeProduct].tier}</span>
                )}
              ...
              <div className="products__card-right">
                ...
                <div className="products__image-placeholder">
                  <Suspense fallback={<LogoIcon size={60} color="rgba(157, 32, 214, 0.35)" />}>
                    <ProductScene
